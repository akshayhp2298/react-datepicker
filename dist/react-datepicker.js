!(function(e, t) {
  ...
  (t = t && Object.prototype.hasOwnProperty.call(t, "default") ? t.default : t),
    ...
    (se =
      se && Object.prototype.hasOwnProperty.call(se, "default")
        ...
        : se),
    (pe =
      pe && Object.prototype.hasOwnProperty.call(pe, "default")
        ? pe.default
        : pe),
    (ce =
  ...
  var Oe = {
      ...
      P: function(e, t) {
        ...
        return r.replace("{{date}}", _e(a, t)).replace("{{time}}", Se(o, t));
      }
    },
    Me = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g;
  function Pe(e) {
  ...
  function Ue(e, t) {
    return Ye(x(Pe(), e), "LLLL", t);
  }
  function Ze(e, t) {
    return Ye(x(Pe(), e), "LLL", t);
  }
  function $e(e, t) {
    return Ye(I(Pe(), e), "QQQ", t);
  }
  function ze(e) {
  ...
  var mt = se(
      (function(e) {
        ...
        function a(e) {
          ...
          return (
            (n.state = {
              yearsList: ft(n.props.year, p, n.props.minDate, n.props.maxDate)
            }),
            n
          );
        }
  ...
  function Dt(e, t) {
    for (var r = [], n = Re(e), a = Re(t); !ee(n, a); )
      r.push(Pe(n)), (n = d(n, 1));
    return r;
  }
  var kt = se(
          ...
          return (
            ...
            fe(ge((n = r.call(this, e))), "renderOptions", function() {
              return n.state.monthYearsList.map(function(e) {
                var r = P(e),
                  a = qe(n.props.date, e) && Ae(n.props.date, e);
                return t.createElement(
                  "div",
                  {
                    className: a
            ...
            (n.state = {
              monthYearsList: Dt(n.props.minDate, n.props.maxDate)
            }),
            n
          );
        }
    ...
    gt = (function(e) {
      ...
      function n() {
        ...
        return (
          ...
          fe(ge(e), "renderSelectOptions", function() {
            for (
              var r = Re(e.props.minDate), n = Re(e.props.maxDate), a = [];
              !ee(r, n);
              ...
              a.push(
                t.createElement(
                  "option",
                  { key: o, value: o },
                  Ye(r, e.props.dateFormat, e.props.locale)
                )
              ),
                (r = d(r, 1));
            }
          ...
          fe(ge(e), "renderReadView", function(r) {
            var n = Ye(e.props.date, e.props.dateFormat, e.props.locale);
            return t.createElement(
              "div",
              {
                key: "read",
          ...
          fe(ge(e), "onChange", function(t) {
            e.toggleDropdown();
            var r = Pe(parseInt(t));
            (qe(e.props.date, r) && Ae(e.props.date, r)) || e.props.onChange(r);
          }),
          fe(ge(e), "toggleDropdown", function() {
            return e.setState({ dropdownVisible: !e.state.dropdownVisible });
          }),
      ...
      function a() {
        ...
        return (
          ...
          fe(ge(e), "getAriaLabel", function() {
            ...
            return "".concat(p, " ").concat(Ye(r, "PPPP"));
          }),
      ...
      function n() {
        ...
        return (
          ...
          fe(ge(e), "renderDays", function() {
            var r = je(e.props.day, e.props.locale, e.props.calendarStartDay),
              n = [],
      ...
      function a() {
        ...
        return (
          ...
          fe(ge(e), "onMonthClick", function(t, r) {
            e.handleDayClick(Re(x(e.props.day, r)), t);
          }),
          fe(ge(e), "onQuarterClick", function(t, r) {
            e.handleDayClick(Fe(I(e.props.day, r)), t);
          }),
            ...
            value: function() {
              ...
              return t.createElement(
                "div",
                {
                  ...
                  "aria-label": "".concat(s, " ").concat(Ye(a, "yyyy-MM"))
                },
                r
                  ? this.renderMonths()
                  : n
  ...
  fe(Ot, "calcCenterPosition", function(e, t) {
      ...
      function a(e) {
        ...
        return (
          ...
          fe(ge(t), "onYearClick", function(e, r) {
            var n;
            t.handleYearClick(((n = T(t.props.date, r)), K(n)), e);
          }),
          t
        );
      }
      ...
      function n(e) {
        ...
        de(this, n),
          fe(ge((a = r.call(this, e))), "resetInputBox", function(e) {
            ...
            a.setState({ time: Ye(e, n), activeState: t, notValid: !1 });
          }),
          ...
          fe(ge(a), "handleTimeSelectionClick", function(e) {
            a.setState({ time: Ye(e, a.state.timeFormat) }, function() {
        ...
        var o,
          ...
          i = s.getHours();
        "12" === a.props.timeFormat && (o = parseInt(i, 10) > 12 ? "PM" : "AM");
        ...
        return (
          ...
          fe(ge(o), "header", function() {
            var e =
                arguments.length > 0 && void 0 !== arguments[0]
                  ? arguments[0]
                  : o.state.date,
              r = je(e, o.props.locale, o.props.calendarStartDay),
              a = [];
            return (
          ...
          fe(ge(o), "renderCurrentMonth", function() {
            ...
            return (
              ...
              t.createElement(
                "div",
                { className: r.join(" ") },
                Ye(e, o.props.dateFormat, o.props.locale)
              )
            );
          }),
              ...
              t.createElement(
                ...
                o.props.showYearArrows &&
                  t.createElement(
                    ...
                    t.createElement(Nt, {
                      onClick: function() {
                        pt(o.state.date, o.props) || o.decreaseYear();
                      }
                    })
                  ),
                t.createElement(
                ...
                o.props.showYearArrows &&
                  t.createElement(
                    ...
                    t.createElement(Yt, {
                      onClick: function() {
                        it(o.state.date, o.props) || o.increaseYear();
                      }
                    })
                  )
              ),
          ...
          fe(ge(o), "renderYearHeader", function() {
            return t.createElement(
              ...
              o.props.showYearPicker
                ? "".concat(M(o.state.date) - 11, " - ").concat(M(o.state.date))
                : M(o.state.date)
            );
          }),
          ...
          [
            {
              ...
              value: function() {
                ...
                this.props.popperContainer &&
                  ...
                  f && !s && (e = t.createElement(Ft, { portalId: f }, e));
        ...
        return (
          ...
          fe(ge(s), "handleChange", function() {
            ...
            if (
              ...
              var a = Ee(n.target.value, s.props.dateFormat, s.props.locale);
          ...
          fe(ge(s), "setPreSelection", function(e) {
            ...
            e &&
              (t && r
                ? (n = Ve(e, s.props.minDate, s.props.maxDate))
                : t
          ...
          fe(ge(s), "onInputKeyDown", function(e) {
            ...
            if (s.state.open || s.props.inline || s.props.preventOpenOnFocus) {
              if (s.state.open) {
                ...
                "Enter" === t
                  ? (e.preventDefault(),
                    s.inputOk() && s.state.lastPreSelectChange === Ht
                      ? (s.handleSelect(n, e),
          ...
          fe(ge(s), "onDayKeyDown", function(e) {
            ...
            if ("Enter" === t)
              ...
              e.preventDefault(),
                s.setState({ lastPreSelectChange: Ht }),
          ...
          fe(ge(s), "renderDateInput", function() {
            ...
            return t.cloneElement(
              ...
              fe(e, "className", n(c.props.className, i)),
